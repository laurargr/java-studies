...
public class Test {
  public static void main(String[] args) {
    ...
    // User[] todosOsUsuarios = new User[5];
    ...
    // for (User user: todosOsUsuarios) {
    //   user.getInfo();
    // }

    // scanner.close();
    // Pet dog = new Dog("hope", "maltipoo", 2);
    // dog.calculateAgeInHumanYears();
    // dog.favoriteToy("ball");
    // Pet bird = new Bird("catita", "corvo", 1);
    // bird.favoriteToy("barbie");
    // bird.calculateAgeInHumanYears();
    // GymMembership normal = new GymMembership("laura", 4);
    // normal.membershipFee();
    // System.out.println(normal.getDuration());
